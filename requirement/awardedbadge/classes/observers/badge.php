...
namespace superbadgesrequirement_awardedbadge\observers;
 ...
 */
class badge {
    public static function awarded(\core\event\badge_awarded $event) {
        global $DB;

        $requirements = $DB->get_records('local_superbadges_requirements', [
            'method' => 'awardedbadge', 'target' => $event->objectid
        ]);
