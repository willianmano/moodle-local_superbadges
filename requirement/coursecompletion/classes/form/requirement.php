...
namespace superbadgesrequirement_coursecompletion\form;
...
class requirement extends \core_form\dynamic_form {
    ...
    public function set_data_for_dynamic_submission(): void {
        $this->set_data([
            'method' => $this->optional_param('method', 'coursecompletion', PARAM_TEXT),
    ...
    public function definition() {
        ...
        $course = $DB->get_record('course', ['id' => $this->courseid], 'id, fullname', MUST_EXIST);

        $mform->addElement('select', 'target', get_string('course', 'superbadgesrequirement_coursecompletion'), [$course->id => $course->fullname]);
        $mform->addHelpButton('target', 'course', 'superbadgesrequirement_coursecompletion');
